      ...
      <div id="product_intro" class="container_12">
        <div id="product_intro_info" class="grid_5">
          <div style="position: relative;">
            <h2><a href="#">Caterpillar 330C</a></h2>
            <div class="s_rating_holder">
              <p class="s_rating s_rating_big s_rating_5"> <span style="width: 100%;" class="s_percent"></span> </p>
              <span class="s_average">5 de 5</span> </div>
            <p class="s_desc"> ¡Aproveche está única oportunidad!</p>
            <div class="s_price_holder">
              <p class="s_price"> <span class="s_currency s_before">$</span>430000 </p>
            </div>
          </div>
          <?php if(isset($promociones)) : foreach($promociones as $row) : ?>
            ...
            <div class="s_rating_holder">
              ...
              <span class="s_average">3 de 5</span> </div>
        ...
        <div id="product_intro_preview">
          ...
          <div class="slideItem" style="display: none"><a href="#"><img src="<?php echo base_url(); ?>img/frontend/default.jpg" alt="" /></a></div>
          <?php if(isset($promociones)) : foreach($promociones as $row) : ?>
